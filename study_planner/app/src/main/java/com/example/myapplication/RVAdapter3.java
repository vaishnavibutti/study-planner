...
public class RVAdapter3 extends RecyclerView.Adapter<RVAdapter3.viewHolder3>{
    List<String> mItems;
    static ArrayList<RVAdapter.ItemModel> arrayList;
    public RVAdapter3(ArrayList<RVAdapter.ItemModel> mItems){arrayList=mItems;}
    @NonNull
    @Override
    public RVAdapter3.viewHolder3 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.first_list,parent,false);
        return new RVAdapter3.viewHolder3(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RVAdapter3.viewHolder3 holder, int position) {
        ...
        holder.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseFirestore.getInstance().collection("Lecture").document(d).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                ...
                FirebaseFirestore.getInstance().collection(da).document("Lecture").update("number", FieldValue.increment(-1));
