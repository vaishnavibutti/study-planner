...
public class RVAdapter2 extends RecyclerView.Adapter<RVAdapter2.viewHolder2> {
    List<String> mItems;
    static ArrayList<RVAdapter.ItemModel> arrayList;
    public RVAdapter2(ArrayList<RVAdapter.ItemModel> mItems){arrayList=mItems;}

    @NonNull
    @Override
    public RVAdapter2.viewHolder2 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.first_list,parent,false);
        return new viewHolder2(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RVAdapter2.viewHolder2 holder, int position) {
        ...
        holder.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseFirestore.getInstance().collection("Assignment").document(d).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                ...
                FirebaseFirestore.getInstance().collection(da).document("Assignment").update("number", FieldValue.increment(-1));
